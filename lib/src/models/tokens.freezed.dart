...
class _$TokensImpl implements _Tokens {
  const _$TokensImpl(
      ...
      @NullableDateTimeTryParseConverter() this.expiresAt});
  ...
  @override
  String toString() {
    return 'Tokens(accessToken: $accessToken, refreshToken: $refreshToken, tokenType: $tokenType, expiresAt: $expiresAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, accessToken, refreshToken, tokenType, expiresAt);
...
abstract class _Tokens implements Tokens {
  const factory _Tokens(
          ...
          @NullableDateTimeTryParseConverter() final DateTime? expiresAt}) =
      _$TokensImpl;
